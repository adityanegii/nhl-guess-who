...
import GuessWhoPopUp from '../components/GuessWhoPopUp'
...
export default function GuessWho() {
  ...
  const [interimGuess, setInterimGuess] = useState('');
  const [numGuesses, setNumGuesses] = useState(0);

  const [guesses, setGuesses] = useState([]); // [id, name, teamId]
  ...
  return (
    <div>
      ...
      <section>
        <a className={styles.homeButton} href='/'><img src='home.svg' alt='home button' height='50px'/></a>
      </section>
      ...
      <section className= {styles.container}>
        ...
        {(numGuesses == 7 || won==true) && <GuessWhoPopUp props={won} playerInfo={playerInfo}/>}
        </div>      
